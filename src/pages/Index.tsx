...
import { ArrowRight, Building2, Truck, MapPin, Clock, Shield, Users, BarChart3, CheckCircle, Star, Zap, Globe, Headphones } from "lucide-react";
...
const Index = () => {
  ...
  const benefits = ["Redução de até 40% nos custos de entrega", "Aumento de 95% na satisfação do cliente", "Integração simples com seu sistema atual", "Suporte técnico especializado 24/7", "Escalabilidade para crescer com seu negócio"];
  const stats = [{
    number: "10k+",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <Button variant="outline" size="sm" onClick={() => navigate("/auth")} className="border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10">
                Entrar
              </Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="hero" size="xl" onClick={() => navigate("/auth")} className="shadow-custom-glow">
                  Começar Agora
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button variant="outline" size="xl" className="border-primary-foreground/30 text-primary-foreground bg-orange-400 hover:bg-orange-300">
                  Ver Demonstração
                </Button>
              </div>
      ...
      <section className="py-20 bg-gradient-subtle">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => <Card key={index} className="shadow-custom-md hover:shadow-custom-lg transition-smooth border-0 bg-card/50 backdrop-blur">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <Button variant="secondary" size="lg" onClick={() => navigate("/auth")} className="shadow-custom-md">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="cta" size="xl" onClick={() => navigate("/auth")} className="shadow-custom-lg">
